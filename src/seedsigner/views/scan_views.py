...
from seedsigner.models import DecodeQR, Seed, QRType
from seedsigner.models.settings import SettingsConstants

from .view import BackStackView, HomeView, PSBTCheckView, NotYetImplementedView, View, Destination
...
class ScanView(View):
    def run(self):
        ...
        self.decoder = DecodeQR(self.controller, wordlist_language_code=wordlist_language_code)
        ...
        if self.decoder.is_complete:
            ...
            elif self.controller.scan_target in [QRType.SEED]:
                print(self.controller.root_key)
                return Destination(self.controller.next_view, skip_current_view=True)
